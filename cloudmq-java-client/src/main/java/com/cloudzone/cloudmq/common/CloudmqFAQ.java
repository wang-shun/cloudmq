...
public class CloudmqFAQ {
    public static final String CONNECT_NAMESRV_FAILED = "NameServer 地址不存在,找不到MQ的NameServer!";
    public static final String CONNECT_BROKER_FAILED = "无法连接Broker，请检查网络设置！";
    public static final String TOPIC_NOT_EXIST = "获取不到Topic: %s 的路由信息，如新建请联系管理员!";
    public static final String SEND_MSG_FAILED = "发送消息超时%dms，Topic: %s 请检查NameServer、Broker连接是否正确!";
