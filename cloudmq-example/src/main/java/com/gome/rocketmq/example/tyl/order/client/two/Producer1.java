package com.gome.rocketmq.example.tyl.order.client.two;
...
public class Producer1 {
    ...
    private static final String topic = "orderTopic_2";
    private static final String groupName = "TwoProducerGroup";
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 0; i < sendOneTime; i++) {
                message = new Message(topic, "A", ("two-A-" + i).getBytes());
