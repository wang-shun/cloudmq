...
public class GClientLogger {
    ...
    static {
        log = createLogger(LoggerName.GmqClientoggerName);
    }
    ...
    private static Logger createLogger(final String loggerName) {
        ...
        final String log4j_resource_file =
                System.getProperty("rocketmq.client.log4j.resource.fileName", "log4j_gmq_client.xml");

        final String logback_resource_file =
                System
                        .getProperty("rocketmq.client.logback.resource.fileName", "logback_gmq_client.xml");
        ...
        return LoggerFactory.getLogger(LoggerName.GmqClientoggerName);
    }
