 ...
 */
package com.alibaba.rocketmq.tools.command.user;
...
public class UpdateUserSubCommand implements SubCommand {
    ...
    public Options buildCommandlineOptions(Options options) {
        ...
        Option opt = new Option("r", "realName", true, "Set real name!");
        opt.setRequired(true);
        options.addOption(opt);

        opt = new Option("u", "userName", true, "Set user name!");
        opt.setRequired(true);
        options.addOption(opt);

        opt = new Option("ui", "id", true, "Set user name!");
        opt.setRequired(true);
        options.addOption(opt);

        opt = new Option("t", "mobile", true, "Set mobile num!");
        opt.setRequired(true);
        options.addOption(opt);

        opt = new Option("e", "email", true, "Set email address!");
        opt.setRequired(true);
        options.addOption(opt);
    ...
    public void execute(final CommandLine commandLine, final Options options, RPCHook rpcHook) {
        ...
        try {
            ...
            if (commandLine.hasOption('b')) {
                ...
                System.out.printf("create user to %s success.\n", addr);
