...
public class ProducerDelayTest {
    public static void main(String[] args) {
        ...
        // 您在控制台创建的ProducerId
        properties.put(PropertiesConst.Keys.ProducerId, "ProducerDelayTestId-test");
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Message msg = new Message( //
                ...
                ("Hello MQ " + i + " MsgBornTime: " + new Date()).getBytes());
            // 设置代表消息的业务关键属性，请尽可能全局唯一。（例如订单ID）。
            // 以方便您在无法正常收到消息情况下，可通过MQ控制台查询消息并补发。
            // 注意：不设置也不会影响消息正常收发
            msg.setKey("ORDERID_" + i);

            // deliver time level 为延时等级,具体值参考DelayLevelConst枚举类，
