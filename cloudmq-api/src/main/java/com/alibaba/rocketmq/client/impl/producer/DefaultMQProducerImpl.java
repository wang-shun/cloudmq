...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private SendResult sendDefaultImpl(//
        ...
        throw new MQClientException("No route info of this topic, " +  msg.getTopic() + ", Pleace check the nameserver[nameserver:" + this.getmQClientFactory().getMQClientAPIImpl().getNameServerAddressList() + "] is corrent?"
